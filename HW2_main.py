...
def evaluate(model, criterion, dataloader, pad_id, tokenizer, device):
    losses = 0
...
if __name__=='__main__':
    ...
    tokenizer.load('wmt16.model')

    with open('restriced_vocab', 'r') as f:
        vocabs = json.load(f)
    
    tokenizer.set_vocabulary(vocabs)
